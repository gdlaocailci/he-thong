...
async function taiDuLieuTKB(tuan) {
    ...
    vungHienThi.innerHTML = `<tr><td class="text-center text-blue-600 font-medium py-10 reactbits-fade-in">Đang đồng bộ phân công, đếm số tiết và vẽ ma trận tự động...</td></tr>`;
