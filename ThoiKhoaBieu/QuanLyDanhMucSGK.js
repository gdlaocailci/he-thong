// =========================================================================
// PHÂN HỆ QUẢN LÝ DANH MỤC SÁCH GIÁO KHOA (V2.0 - TÍCH HỢP DATALIST MÔN HỌC)
// Nâng cấp: Tự động tải Danh sách Môn từ KHUNG_CHUONG_TRINH để làm gợi ý nhập liệu
// =========================================================================
...
function xayDungGiaoDienQuanLyDanhMucSGK() {
    ...
    <div id="vungQuanLyDanhMucSGK" class="hidden fixed inset-0 z-[80] bg-slate-900/70 backdrop-blur-sm flex items-center justify-center p-4 transition-opacity">
        <div class="bg-white w-full max-w-6xl h-[88vh] rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-slate-300">
            ...
            <!-- Danh sách mảng ẩn phục vụ cho Ô nhập liệu (Autocomplete) -->
...
// =========================================================================
// KHỐI 3: THUẬT TOÁN TẢI DỮ LIỆU KÉP TỪ MÁY CHỦ VÀ VẼ LÊN BẢNG
// =========================================================================
async function taiLaiDuLieuDanhMucSGK() {
    ...
    try {
        ...
        // 1. Đổ dữ liệu vào Datalist để làm gợi ý cho ô Môn học
        const datalist = document.getElementById('danhSachMonHocSGK');
        datalist.innerHTML = ''; // Làm sạch list cũ
...
function taoDongGiaoDienDuLieu(khoi = '', mon = '', link1 = '', link2 = '') {
    ...
    tr.innerHTML = `
        ...
        <!-- [CẬP NHẬT GIAO DIỆN]: Bổ sung list="danhSachMonHocSGK" để kích hoạt chế độ Vừa nhập vừa Chọn -->
